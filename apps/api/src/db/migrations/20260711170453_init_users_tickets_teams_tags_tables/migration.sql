...
--> statement-breakpoint
CREATE TABLE "ticket_status_hsitory" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
	"ticket_id" uuid NOT NULL,
...
ALTER TABLE "ticket_status_hsitory" ADD CONSTRAINT "ticket_status_hsitory_ticket_id_tickets_id_fkey" FOREIGN KEY ("ticket_id") REFERENCES "tickets"("id");--> statement-breakpoint
ALTER TABLE "ticket_status_hsitory" ADD CONSTRAINT "ticket_status_hsitory_changed_by_users_id_fkey" FOREIGN KEY ("changed_by") REFERENCES "users"("id");--> statement-breakpoint
